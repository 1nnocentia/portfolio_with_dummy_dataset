<nav class="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm shadow-sm transition-all duration-300" id="navbar">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {{-- Mobile Menu button --}}
        <div class="md:hidden">
            <button type="button" class="mobile-menu-buton">
    ...
    <div class="md:hidden mobile-menu hidden">
        <div class="px-2 pt-2 pb-2 space-y-1 sm:px-3 bg-white shadow-lg">
            ...
            <a href="{{  route('resume') }}" class="mobile-nav-link {{ request()->routeIs('resume') ? 'active' : '' }}">
                Resume
            </a>
